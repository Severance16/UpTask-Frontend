...
export default function ForgotPasswordView() {
  ...
  return (
    <>
      <h1 className="text-5xl font-black text-white">Reestablecer Contaseña</h1>
      <p className="text-2xl font-light text-white mt-5">
        ¿Olvidaste tu contraseña? llena el formulario {""}
        <span className=" text-fuchsia-500 font-bold"> y reestablece tu contraseña</span>
      </p>
      <form
        onSubmit={handleSubmit(handleForgotPassword)}
        className="space-y-8 p-10 mt-10 rounded-lg bg-white"
        noValidate
      >
